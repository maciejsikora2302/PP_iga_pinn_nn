...
%         params_u1=[vec_a1, vec_b1, vec_c1, vec_d1];
%         params_u2=[vec_a2, vec_b2, vec_c2, vec_d2];
%         params_u3=[vec_a3, vec_b3, vec_c3, vec_d3];
        ...
        vec_a2(idx)=vec_a2(idx) - eta2*derror_u2_1a;
        vec_b2(idx)=vec_b2(idx) - eta2*derror_u2_1b;
        vec_c2(idx)=vec_c2(idx) - eta2*derror_u2_1c;
        vec_d2(idx)=vec_d2(idx) - eta2*derror_u2_1d;

        vec_a3(idx)=vec_a3(idx) - eta3*derror_u3_1a;
        vec_b3(idx)=vec_b3(idx) - eta3*derror_u3_1b;
        vec_c3(idx)=vec_c3(idx) - eta3*derror_u3_1c;
        vec_d3(idx)=vec_d3(idx) - eta3*derror_u3_1d;
        ...
        vec_a1(idx)=vec_a1(idx) - eta1*derror_u1_2a;
        vec_b1(idx)=vec_b1(idx) - eta1*derror_u1_2b;
        vec_c1(idx)=vec_c1(idx) - eta1*derror_u1_2c;
        vec_d1(idx)=vec_d1(idx) - eta1*derror_u1_2d;
        ...
        vec_a3(idx)=vec_a3(idx) - eta3*derror_u3_2a;
        vec_b3(idx)=vec_b3(idx) - eta3*derror_u3_2b;
        vec_c3(idx)=vec_c3(idx) - eta3*derror_u3_2c;
        vec_d3(idx)=vec_d3(idx) - eta3*derror_u3_2d;
        ...
        vec_a1(idx)=vec_a1(idx) - eta1*derror_u1_3a;
        vec_b1(idx)=vec_b1(idx) - eta1*derror_u1_3b;
        vec_c1(idx)=vec_c1(idx) - eta1*derror_u1_3c;
        vec_d1(idx)=vec_d1(idx) - eta1*derror_u1_3d;

        vec_a2(idx)=vec_a2(idx) - eta2*derror_u2_3a;
        vec_b2(idx)=vec_b2(idx) - eta2*derror_u2_3b;
        vec_c2(idx)=vec_c2(idx) - eta2*derror_u2_3c;
        vec_d2(idx)=vec_d2(idx) - eta2*derror_u2_3d;
...
% hold on
plot(x,dataset_u1);
% plot(x,yeval_u1(1:50),x,dataset_u1,x,yeval_u2(1:50),x,dataset_u2,x,yeval_u3(1:50),x,dataset_u3);
% h=legend('u1','ANN aproximation of u1','u2', 'ANN aproximation of u2','u3', 'ANN aproximation of u3');
% set(h,'FontSize',10);

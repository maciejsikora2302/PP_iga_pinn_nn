...
parser = OptionParser()
parser.add_option("-s", "--save", dest="save", action="store_true", default=True, help="do we need to save to disk")
parser.add_option("-a", "--activation_function", dest="activation_function", default="tanh", help="dfefine which activation function should be used for training")
parser.add_option("-e", "--epochs", dest="epochs", default="1000", help="how many epochs")
parser.add_option("-l", "--learning_rate", dest="rate", default="0.2", help="how big the learning rate")
parser.add_option("-d", "--dataset_path", dest="dataset_path", default="./dataset2k.txt", help="path to dataset")
